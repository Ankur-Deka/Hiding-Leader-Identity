...
from joint_main_genetic import jointController
...
if __name__ == '__main__':
    ...
    for i,ckpt in enumerate(ckpts):
        ...
        for team_task_rew, team_priv_reward in zip(task_rewards, privacy_rewards):
            ...
            metrics_dict['Privacy reward'].append(team_priv_reward.mean())

    df = pd.DataFrame(metrics_dict)
    df.to_csv('Plotting_data_229.csv')
    # print(task_rewards)
