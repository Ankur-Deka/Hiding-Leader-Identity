...
class Scenario(BaseScenario):
    ...
    def make_world(self):
        world = World('simple_dual_waypoints')
    ...
    def reset_world(self, world):
        ...
        world.waypoints = []
        for i in range(2):
            world.waypoints.append(np.random.uniform(*left_limits) if np.random.randint(2) else np.random.uniform(*right_limits))
        goal_loc = world.waypoints[0]
        # print('waypoints', self.waypoints)
        world.intervals = [50,100]
